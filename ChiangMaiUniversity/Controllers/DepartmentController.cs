    ...
    public class DepartmentController : Controller
    {
        ...
        public async Task<ActionResult> Delete(int? id, bool? concurrencyError)
        {
            ...
            if (concurrencyError.GetValueOrDefault())
            {
                if (department == null)
                {
                    ViewBag.ConcurrencyErrorMessage = "The record you attempted to delete was deleted by another user";
                }
                else
                {
                    ViewBag.ConcurrencyErrorMessage = "The record you attempted tp delete was modified by another user. If you stil want to delete this record, click the delete button.";
                }
            }
            return View(department);
        }
